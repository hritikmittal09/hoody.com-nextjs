  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">{ProductDetails.title}e</h1>
        ...
        <div className="flex">
          ...
          <button className="flex ml-auto text-white  border-0 py-2 px-6 focus:outline-none  rounded   bg-red-500">Order Now</button>
